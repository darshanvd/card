    ...
    if (parentElement) {
      ...
      if (tabsdiv != null) {
        ...
        if (datarecord.status == "active") {
          status = '<div style="margin: 10px; color:green"><b style="color:black">Status:</b>Active</div>';
        } else if (datarecord.status == "inactive") {
          status = '<div style="margin: 10px; color:red"><b style="color:black">Status:</b>Inactive</div>';
        } else {
